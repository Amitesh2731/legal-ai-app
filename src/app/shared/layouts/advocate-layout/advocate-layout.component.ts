    ...
    <ion-split-pane contentId="main-content">
      ...
      <ion-menu contentId="main-content" type="overlay">
        <ion-header class="ion-no-border">
          <ion-toolbar>
            <ion-title>Advocate Portal</ion-title>
          </ion-toolbar>
        </ion-header>
        <ion-content>
          <div class="menu-header">
            <div class="logo-box"><ion-icon name="document-text-outline"></ion-icon></div>
            <h2>Legal AI</h2>
          </div>
          <ion-list lines="none" class="nav-list">
            <ion-menu-toggle auto-hide="false">
              <ion-item routerLink="/advocate/dashboard" routerLinkActive="selected">
                <ion-icon slot="start" name="home-outline"></ion-icon>
                <ion-label>Dashboard</ion-label>
              </ion-item>
              <ion-item routerLink="/advocate/cases" routerLinkActive="selected">
                <ion-icon slot="start" name="briefcase-outline"></ion-icon>
                <ion-label>Assigned Cases</ion-label>
              </ion-item>
              <ion-item routerLink="/advocate/opinions" routerLinkActive="selected">
                <ion-icon slot="start" name="document-text-outline"></ion-icon>
                <ion-label>Opinions</ion-label>
              </ion-item>
              <ion-item routerLink="/advocate/notifications" routerLinkActive="selected">
                <ion-icon slot="start" name="notifications-outline"></ion-icon>
                <ion-label>Alerts</ion-label>
              </ion-item>
              <ion-item routerLink="/advocate/profile" routerLinkActive="selected">
