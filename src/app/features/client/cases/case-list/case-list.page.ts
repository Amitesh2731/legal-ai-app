...
import { 
  ...
  IonSearchbar, IonFab, IonFabButton, IonIcon, IonList, IonItem, IonLabel,
  IonSkeletonText, IonButton, IonButtons, IonModal, IonSelect, IonSelectOption
} from '@ionic/angular/standalone';
import { addIcons } from 'ionicons';
import { add, filterOutline, searchOutline, documentTextOutline, alertCircleOutline } from 'ionicons/icons';
...
@Component({
  ...
  imports: [
    ...
    IonHeader, IonToolbar, IonTitle, IonContent, IonRefresher, IonRefresherContent,
    IonSearchbar, IonFab, IonFabButton, IonIcon, IonSkeletonText, IonButton,
  ...
  template: `
    ...
    <ion-content>
      ...
      <div class="content-container">
        @if (isLoading && cases.length === 0) {
            ...
            @for (i of [1,2,3,4]; track i) {
              <div class="skeleton-card">
                ...
                <div class="skel-body">
                  ...
                  <ion-skeleton-text animated style="width: 100%; height: 16px; margin-bottom: 12px;"></ion-skeleton-text>
          ...
          <app-empty-state 
            ...
            description="You don't have any cases matching your criteria." 
            [actionLabel]="activeFiltersCount > 0 || searchQuery ? 'Clear Filters' : 'Create New Case'" 
            (action)="activeFiltersCount > 0 || searchQuery ? clearFilters() : openCreateCase()">
          </app-empty-state>
        } @else {
          <div class="case-list">
      ...
      <!-- FAB for creating new case -->
      <ion-fab vertical="bottom" horizontal="end" slot="fixed">
        <ion-fab-button (click)="openCreateCase()">
...
export class ClientCaseListPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({ add, filterOutline, searchOutline, documentTextOutline, alertCircleOutline });
  }
  ...
  loadCases(event?: any) {
    ...
    this.caseService.getCases(params)
      ...
      .subscribe({
        ...
        error: (err) => {
          this.error = 'Unable to load your cases. Please try again later.';
          console.error(err);
        }
      });
  }
  ...
  openCaseDetails(c: CaseResponse) {
    this.router.navigate(['/client/cases', c.id]);
  }
  
  openCreateCase() {
    this.router.navigate(['/client/cases/new']);
  }
